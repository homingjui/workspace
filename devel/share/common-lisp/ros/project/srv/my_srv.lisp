...
(cl:defmethod cl:initialize-instance :after ((m <my_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'my_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project-srv:<my_srv-request> is deprecated: use project-srv:my_srv-request instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <my_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project-srv:id-val is deprecated.  Use project-srv:id instead.")
  (id m))
...
(cl:defmethod cl:initialize-instance :after ((m <my_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'my_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project-srv:<my_srv-response> is deprecated: use project-srv:my_srv-response instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <my_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project-srv:name-val is deprecated.  Use project-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'gender-val :lambda-list '(m))
(cl:defmethod gender-val ((m <my_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project-srv:gender-val is deprecated.  Use project-srv:gender instead.")
  (gender m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <my_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project-srv:age-val is deprecated.  Use project-srv:age instead.")
  (age m))
