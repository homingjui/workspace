...
(cl:defmethod cl:initialize-instance :after ((m <my_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'my_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project-msg:<my_msg> is deprecated: use project-msg:my_msg instead.")))

(cl:ensure-generic-function 'connect-val :lambda-list '(m))
(cl:defmethod connect-val ((m <my_msg>))
...
(cl:defmethod leftX-val ((m <my_msg>))
...
(cl:defmethod leftR-val ((m <my_msg>))
...
(cl:defmethod rightX-val ((m <my_msg>))
...
(cl:defmethod rightY-val ((m <my_msg>))
...
(cl:defmethod leftTrg-val ((m <my_msg>))
...
(cl:defmethod rightTrg-val ((m <my_msg>))
...
(cl:defmethod padUp-val ((m <my_msg>))
...
(cl:defmethod padDown-val ((m <my_msg>))
...
(cl:defmethod padLeft-val ((m <my_msg>))
...
(cl:defmethod padRight-val ((m <my_msg>))
...
(cl:defmethod bumperLeft-val ((m <my_msg>))
...
(cl:defmethod bumperRight-val ((m <my_msg>))
