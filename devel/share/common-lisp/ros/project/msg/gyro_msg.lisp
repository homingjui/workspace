...
(cl:defmethod cl:initialize-instance :after ((m <gyro_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gyro_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project-msg:<gyro_msg> is deprecated: use project-msg:gyro_msg instead.")))

(cl:ensure-generic-function 'acc_x-val :lambda-list '(m))
(cl:defmethod acc_x-val ((m <gyro_msg>))
...
(cl:defmethod acc_y-val ((m <gyro_msg>))
...
(cl:defmethod acc_z-val ((m <gyro_msg>))
...
(cl:defmethod gyro_x-val ((m <gyro_msg>))
...
(cl:defmethod gyro_y-val ((m <gyro_msg>))
...
(cl:defmethod gyro_z-val ((m <gyro_msg>))
...
(cl:defmethod angle_x-val ((m <gyro_msg>))
...
(cl:defmethod angle_y-val ((m <gyro_msg>))
...
(cl:defmethod angle_z-val ((m <gyro_msg>))
