...
(cl:defclass <joystick_msg> (roslisp-msg-protocol:ros-message)
  ((connect
    :reader connect
    :initarg :connect
    :type cl:boolean
...
(cl:defclass joystick_msg (<joystick_msg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <joystick_msg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'joystick_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project-msg:<joystick_msg> is deprecated: use project-msg:joystick_msg instead.")))

(cl:ensure-generic-function 'connect-val :lambda-list '(m))
(cl:defmethod connect-val ((m <joystick_msg>))
...
(cl:defmethod leftX-val ((m <joystick_msg>))
...
(cl:defmethod leftY-val ((m <joystick_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project-msg:leftY-val is deprecated.  Use project-msg:leftY instead.")
  (leftY m))

(cl:ensure-generic-function 'rightX-val :lambda-list '(m))
(cl:defmethod rightX-val ((m <joystick_msg>))
...
(cl:defmethod rightY-val ((m <joystick_msg>))
...
(cl:defmethod leftTrg-val ((m <joystick_msg>))
...
(cl:defmethod rightTrg-val ((m <joystick_msg>))
...
(cl:defmethod A-val ((m <joystick_msg>))
...
(cl:defmethod B-val ((m <joystick_msg>))
...
(cl:defmethod X-val ((m <joystick_msg>))
...
(cl:defmethod Y-val ((m <joystick_msg>))
...
(cl:defmethod padUp-val ((m <joystick_msg>))
...
(cl:defmethod padDown-val ((m <joystick_msg>))
...
(cl:defmethod padLeft-val ((m <joystick_msg>))
...
(cl:defmethod padRight-val ((m <joystick_msg>))
...
(cl:defmethod bumperLeft-val ((m <joystick_msg>))
...
(cl:defmethod bumperRight-val ((m <joystick_msg>))
...
(cl:defmethod guide-val ((m <joystick_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project-msg:guide-val is deprecated.  Use project-msg:guide instead.")
  (guide m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <joystick_msg>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <joystick_msg>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<joystick_msg>)))
  "Returns string type for a message object of type '<joystick_msg>"
  "project/joystick_msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'joystick_msg)))
  "Returns string type for a message object of type 'joystick_msg"
  "project/joystick_msg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<joystick_msg>)))
  "Returns md5sum for a message object of type '<joystick_msg>"
  "feedf0c4942de46502ada06975acd8c3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'joystick_msg)))
  "Returns md5sum for a message object of type 'joystick_msg"
  "feedf0c4942de46502ada06975acd8c3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<joystick_msg>)))
  "Returns full string definition for message of type '<joystick_msg>"
  (cl:format cl:nil "bool connect~%float32 leftX~%float32 leftY~%float32 rightX~%float32 rightY~%float32 leftTrg~%float32 rightTrg~%bool A~%bool B~%bool X~%bool Y~%bool padUp~%bool padDown~%bool padLeft~%bool padRight~%bool bumperLeft~%bool bumperRight~%bool guide~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'joystick_msg)))
  "Returns full string definition for message of type 'joystick_msg"
  (cl:format cl:nil "bool connect~%float32 leftX~%float32 leftY~%float32 rightX~%float32 rightY~%float32 leftTrg~%float32 rightTrg~%bool A~%bool B~%bool X~%bool Y~%bool padUp~%bool padDown~%bool padLeft~%bool padRight~%bool bumperLeft~%bool bumperRight~%bool guide~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <joystick_msg>))
  (cl:+ 0
     1
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <joystick_msg>))
  "Converts a ROS message object to a list"
  (cl:list 'joystick_msg
