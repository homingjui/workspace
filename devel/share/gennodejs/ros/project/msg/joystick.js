...
class joystick {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('leftR')) {
        this.leftR = initObj.leftR
      }
      else {
        this.leftR = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.leftR, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.leftR = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.leftR !== undefined) {
      resolved.leftR = msg.leftR;
    }
    else {
      resolved.leftR = 0.0
    }
