...
echo_and_run cd "/home/isp/Desktop/workspace/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/isp/Desktop/workspace/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/isp/Desktop/workspace/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
